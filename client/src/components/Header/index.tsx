              ...
              <div className="flex items-center justify-end pr-16 lg:pr-0">
                {session ? (
                  <div className="flex items-center space-x-4">
                    ...
                    <button
                      onClick={() => signOut()}
                      className="flex items-center justify-center px-6 py-2 text-sm font-semibold text-white bg-red-500 rounded-md shadow-md hover:bg-red-600 hover:shadow-lg focus:outline-none focus:ring-2 focus:ring-red-400 focus:ring-offset-2 transition-transform transform hover:scale-105 active:scale-95"
                    >
                      Logout
                    </button>
                  </div>
